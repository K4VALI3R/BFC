...
CREATE DATABASE IF NOT EXISTS bfc;
USE bfc;
ALTER TABLE producto ADD stock INT DEFAULT 0 AFTER categoria;
ALTER TABLE combo ADD stock INT DEFAULT 0 AFTER categoria;
